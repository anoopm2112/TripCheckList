...
export default function rootNavigation(props) {
  ...
  return (
    ...
    >
      ...
      <Screen options={{ title: 'TRIP CHECKLIST', headerRight: () => rightLogoImage() }} name={ROUTE_KEYS.CHECK_ITEM_LIST} component={CheckItemListView} />
      ...
      <Screen options={{ title: t('Settings:setting'), headerRight: () => rightLogoImage() }} name={ROUTE_KEYS.SETTINGS} component={SettingsView} />
    </Navigator>
  );
}